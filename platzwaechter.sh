...
NUR_ANZEIGEN=; STATUS=; TESTMAIL=
for a in "$@"; do case "$a" in -n) NUR_ANZEIGEN=1;; -s) STATUS=1; NUR_ANZEIGEN=1;; -t) TESTMAIL=1;; *) sed -n '2,32p' "$0"; exit 1;; esac; done
