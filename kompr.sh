...
find /DATA/Patientendokumente/HDI\ alt -mindepth 1 -maxdepth 1 -type d -mtime +90 -exec 7z a -t7z -m0=lzma2 -mx=9 -mfb=64 -md=32m -ms=on {}.7z {} \; -exec rm -rf {} \;
find /DATA/Patientendokumente/Dicom -mindepth 1 -maxdepth 1 -type d -mtime +180 -exec echo \"\{\}\" \; -exec 7z a -t7z -m0=lzma2 -mx=9 -mfb=64 -md=32m -ms=on {}.7z {} \; -exec rm -rf {} \; -exec echo Fertig mit {} \;
